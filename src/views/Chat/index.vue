  ...
  <div class="container">
    ...
    <div class="chat-list">
      <div v-for="(obj, index) in list" :key="index">
        <!-- 左侧是机器人小思 -->
        <div class="chat-item left" v-if="obj.name === 'xz'">
          <van-image
            fit="cover"
            round
    ...
    <div class="reply-container van-hairline--top">
      <van-field placeholder="和小智同学对话" v-model="word" v-autofocus>
        <template #button>
...
export default {
  ...
  data() {
    return {
      ...
      list: [
        ...
        { name: "xz", msg: "我是小智" },
        { name: "me", msg: "我是叮咚" },
        { name: "me", msg: "我是一名前端初学者" },
        { name: "me", msg: "努力学习代码知识" },
      ],
  ...
  created() {
    ...
    // 建立连接的事件
    socket.on("connect", () => {
      console.log("webSocket服务器连接成功，实现实时通讯");
    });
    // 接收到消息的事件
    socket.on("message", (data) => {
      ...
      // 数据变化是异步的，真实dom更新在后，需要使用nexttick
      this.$nextTick(() => {
        this.scrollToBottom();
      });
    });
